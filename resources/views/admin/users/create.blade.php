        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title">Add a user with relevant roles and permissions</h4>
                            ...
                            <form class="user" method="post" action="{{ route('admin.users.store') }}">
                                ...
                                <div class="form-group">
                                    <input type="text" name="name" class="form-control form-control-user"
                                        id="name" required autofocus autocomplete="name" placeholder="Enter Name">
                                    @if ($errors->has('name'))
                                ...
                                <div class="form-group">
                                    <input type="email" name="email" class="form-control form-control-user"
                                        id="email" required autofocus autocomplete="email" placeholder="Email Address">
                                    @if ($errors->has('email'))
                                ...
                                <button type="submit" class="btn btn-success btn-block waves-effect waves-light"> Add User
                                </button>
                            </form>
                        </div>
                    </div>
