    ...
    <div data-simplebar class="h-100">
        ...
        <div class="navbar-brand-box">
            <a href="{{ route('dashboard') }}" class="logo">
                ...
                <span>
                    {{ Config::get('app.name', 'Laravel Project') }}
                </span>
            </a>
        </div>
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="{{ route('dashboard') }}" class="waves-effect"><i class="mdi mdi-home-analytics"></i>
                        <span>Dashboard</span></a>
                </li>
                @role('Admin')
                    <li>
                        <a href="{{ route('admin.users.index') }}" class="waves-effect"><i
                                class="mdi mdi-tooltip-account"></i>
                            <span>User Management</span></a>
                    </li>
                    <li>
                        <a href="javascript: void(0);" class="has-arrow waves-effect"><i
                                class="mdi mdi-diamond-stone"></i><span>Roles & Permissions</span></a>
